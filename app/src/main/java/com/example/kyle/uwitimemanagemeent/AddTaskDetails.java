                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext()) {
                            ...
                            buffer.append("StartDate :"+ getDate(res.getLong(2))+"\n");
                            buffer.append("EndDate :"+ getDate(res.getLong(3))+"\n");
                            buffer.append("StarTtime: "+ res.getString(4)+"\n");
                            buffer.append("EndTime: "+ res.getString(5)+"\n");
